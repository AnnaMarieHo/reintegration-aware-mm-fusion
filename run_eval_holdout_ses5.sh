...
DATA="${ROOT}/reintegration/output/partition/holdout_ses_5"
...
OUT="${ROOT}/reintegration/output/eval_results/txt_mask_audio_live/holdout_session_5"

for FOLD in 1 2 3 4 5; do
  CKPT="${ROOT}/reintegration/trained_models/holdout_session_5/${COND}/fold${FOLD}/model.pt"
  echo "=== ${COND} fold ${FOLD} ==="
