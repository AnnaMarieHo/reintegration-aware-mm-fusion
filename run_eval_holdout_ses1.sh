...
DATA="${ROOT}/reintegration/output/partition/holdout_ses_1"
...
OUT="${ROOT}/reintegration/output/eval_results/markov/txt_mask_audio_live/holdout_session_1"

for FOLD in 1 2 3 4 5; do
  CKPT="${ROOT}/reintegration/trained_models/holdout_session_1/${COND}/fold${FOLD}/model.pt"
  echo "=== ${COND} fold ${FOLD} ==="
