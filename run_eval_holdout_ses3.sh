...
OUT="${ROOT}/reintegration/output/eval_results/txt_mask_audio_live/holdout_session_3"

for FOLD in 1 2 3 4 5; do
  CKPT="${ROOT}/reintegration/trained_models/holdout_session_3/${COND}/fold${FOLD}/model.pt"
  echo "=== ${COND} fold ${FOLD} ==="
